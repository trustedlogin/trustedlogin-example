...
class Endpoint {
	...
	/** @var string The $_POST key in the ReplaceMe\TrustedLogin request related to the action being performed. */
	const POST_ACTION_KEY = 'action';

	/** @var string The $_POST key in the ReplaceMe\TrustedLogin request that contains the value of the expected endpoint. */
	...
	public function maybe_login_support() {
		...
		// Not a ReplaceMe\TrustedLogin request.
		if ( ! $request ) {
			return;
		}
	...
	public function maybe_revoke_support() {
		 ...
		 *
		 * @param string $user_identifier Unique ID for ReplaceMe\TrustedLogin support user or "all".
		 */
		 ...
		 *
		 * @param string $user_identifier Unique ReplaceMe\TrustedLogin ID for the Support User or "all"
		 */
	...
	public function add() {
		...
		// Only add the endpoint if a ReplaceMe\TrustedLogin request is being made.
	...
	/**
	 * Returns sanitized data from a ReplaceMe\TrustedLogin login $_POST request.
	 *
	 ...
	 *
	 * @return string|WP_Error This hash will be used as an identifier in ReplaceMe\TrustedLogin SaaS. Or something went wrong.
	 */
