...
final class SupportUser {
	...
	/**
	 * @var int $created_by_meta_key The ID of the user who created the ReplaceMe\TrustedLogin access
	 * @since 1.0.0
	 */
	...
	private function login( WP_User $support_user ) {
		...
		/**
		 * Action run when ReplaceMe\TrustedLogin has logged-in
		 */
	 ...
	 * @param bool $delete_endpoint Should the ReplaceMe\TrustedLogin endpoint for the site be deleted also? Default: `true`.
	 *
